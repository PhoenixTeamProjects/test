    ...
    <>
      ...
      <section className="bg-[#1e3a5f] text-white py-10">
        <div className="max-w-7xl mx-auto px-4">
          <Link href="/products" className="inline-flex items-center gap-1 text-slate-300 hover:text-white mb-4 text-sm">
      ...
      <section className="py-12 md:py-16 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="bg-[#1e3a5f]/10 rounded-xl h-80 lg:h-96 flex items-center justify-center text-[#1e3a5f] font-bold text-5xl">
              {product.name.slice(0, 2).toUpperCase()}
            </div>
            <div>
              <span className="text-xs bg-[#f97316]/10 text-[#f97316] px-3 py-1 rounded-full font-medium">{product.category}</span>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-bold text-[#1e3a5f] text-xl mb-4">Key Features</h3>
            ...
            <div>
              <h3 className="font-bold text-[#1e3a5f] text-xl mb-4">Applications</h3>
              <ul className="space-y-2">
